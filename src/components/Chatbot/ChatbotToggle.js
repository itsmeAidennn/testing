...
const ChatbotToggle = ({chatbotHidden, setChatbotHidden, firstOpen, setFirstOpen}) => {
  ...
  return (
    <div className={`${style.chatbotToggle} ${style.slideLeftIn}`}>
      <button id="openChat" className={`${style.chatBox} ${style.chatbotIcon} ${style.toggleButton}`} onClick={toggleChatbot}>
